                ...
                <g:each in="${pois}" var="poi" status="poi_index">
                    ...
                    <li class="poi ui-state-default" data-poi-id="${poi.id}" data-poi-number="${(poi_index+1)}" data-poi-lat="${poi.lat}" data-poi-lng="${poi.lng}">
                        ...
                        <div class="qrcode_holder">
                            <g:link controller="qrcode" action="text" params="${[text:'jmagine-poi-'+poi.id]}" class="qrcode_modal_link" target="_blank">
                                <qrcode:image height="100" width="100" text="jmagine-poi-${poi.id}"/>
                            </g:link>
                        </div>
                        <div class="body">
                            <h3>${ poi.title }</h3>
