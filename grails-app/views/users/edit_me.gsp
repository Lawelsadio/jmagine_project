...
<body>
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <h1 class="page-header"><g:message code="jmagine.users.edit_me"/></h1>

        <div class="row">
            %{--<g:render template="/parcours_menu_disabled"/>--}%
            <div class="content users">
                <g:form controller="users" action="do_edit" params="${[user_id:user.id,my_account:true]}" enctype="multipart/form-data">
