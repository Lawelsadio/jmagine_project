    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div class="row">
            ...
            <div class="content users">
                <g:form autocomplete="off" controller="users" action="do_add" enctype="multipart/form-data">
                    <input style="display:none" type="text" name="_autocomplete_fix"/>
                    <input style="display:none" type="password" name="_autocomplete_fix_pw"/>
                        ...
                        <g:if test="${!flash.errors?.role}">
                            <sec:ifAllGranted roles="ROLE_OP">
                                <div class="form-group">
                                    ...
                                    <g:select class="form-control" value="${ flash.fields?.role }" name="role" from="${[g.message(code:'jmagine.roles.op'), g.message(code:'jmagine.roles.admin'), g.message(code:'jmagine.roles.mod')]}" keys="${['ROLE_OP', 'ROLE_ADMIN', 'ROLE_MOD']}"/>
                                </div>
                            </sec:ifAllGranted>
                        </g:if>
                        <g:else>
