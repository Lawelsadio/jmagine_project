...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    ...
    <div class="row">
        ...
        <div class="content">
            <g:form controller="sections" action="do_info_edit"
                    params="[p_id: parcours.id, s_id: section.id]" enctype="multipart/form-data">
                <div class="col-xs-6 col-sm-6">
                    <g:if test="${!flash.errors?.title}">
                        <div class="form-group">
                            <label for="title"><g:message code="jmagine.sections.sections_title"/></label>
                            <input class="form-control" name="title" id="title" value="${flash.fields?.title ? flash.fields.title : section.title}" placeholder="<g:message code="jmagine.sections.sections_title"/>">
                        </div>
                    </g:if>
                    <g:else>
                    ...
                    <div class="form-group">
                        ...
                        <g:if test="${flash.errors?.content}">
                            ...
                            <div class="alert alert-danger alert-dismissible" role="alert">
                                ...
                                <g:message code="jmagine.sections.form.errors.content"/>
                            </div>
                            </p>
                        </g:if>
                        <textarea name="content" id="editor">${section.content}</textarea>
                    </div>
...
<script>
    ...
    $( function(){
        ...
        $('.poi_image_uploader').imageUploader({
            ...
            default_image_src:${section.backgroundPic?.filename?raw('"'+g.jmagineImage( src:section.backgroundPic.filename, makelink:true, absolute:true )+'"'):'null'},
